...
export default function SubscriptionSuccessContent() {
  ...
  const planName = params.get("planName") || "DevNext Premium Plan";
  const price = params.get("price") || "29.00";
  const orderId = params.get("orderId") || "SUB-00000";
  const type = params.get("type") || "Monthly • Auto-renew enabled";
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-teal-50 flex items-center justify-center p-4">
      <div className="max-w-2xl w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-lg">Enjoy premium access to all features.</p>
        </div>
        ...
        <div className="text-center mt-8 p-6 bg-white/50 rounded-lg border border-gray-200">
          <p className="text-sm text-gray-600 mb-2">A confirmation email has been sent.</p>
