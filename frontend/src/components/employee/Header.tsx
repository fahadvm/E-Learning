...
export default function Header() {
  ...
  const navLinks = [
    ...
    // { href: "/employee/courses", label: "Courses", icon: <BookOpen size={20} /> },
    { href: "/employee/company", label: "Company", icon: <Users size={20} /> },
    // { href: "/learning-path", label: "Learning Path", icon: <Route size={20} /> },
    { href: "/employee/mycourses", label: "MyCourses", icon: <BookOpen size={20} /> },
  ...
  return (
    <header className="bg-white shadow-md fixed top-0 left-0 w-full z-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex justify-between items-center">
        {/* Brand */}
        <Link href="/employee/home" className="text-2xl font-bold text-indigo-700 tracking-wide">
          DevNext
        </Link>
