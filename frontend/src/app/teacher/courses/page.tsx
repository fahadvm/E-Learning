    ...
    <>
      ...
      <main className="bg-gray-100 min-h-screen p-6 md:p-10">
        <div className="flex justify-between items-center flex-wrap gap-4 mb-6">
          ...
          {teacher.isVerified ? (<Link href="/teacher/courses/create">
            <button className="bg-gradient-to-r from-purple-500 to-indigo-600 text-white px-6 py-2 rounded-lg text-sm font-medium shadow-lg hover:scale-105 transition">
              + Add New Course
            </button>
          </Link>) : ""}
              ...
              >
                ...
                <div className="p-4">
                  ...
                  {/* <div className="mt-4 text-right">
                    <Link
                      href={`/teacher/courses/edit/${course._id}`}
