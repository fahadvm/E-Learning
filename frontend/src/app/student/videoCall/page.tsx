...
export default function StudentPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4">
            <h1 className="text-3xl font-bold mb-4">Student Video Call</h1>
            <div className="mb-4">
                <input
                    type="text"
            ...
            <div className="flex space-x-4">
                ...
                <div>
                    <h2 className="text-lg font-semibold">Teacher Video</h2>
                    <video ref={remoteVideoRef} autoPlay className="w-80 h-60 bg-black rounded" data-user-id="" />
                </div>
            </div>
            <p className="mt-4">{isConnected ? 'Connected to teacher' : 'Waiting for teacher...'}</p>
        </div>
    );
};
