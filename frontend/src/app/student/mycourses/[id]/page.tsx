...
export default function CoursePage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleSubmitReview = async (rating: number, comment: string) => {
    await studentCourseApi.addCourseReview({ courseId, rating, comment });
  };
  ...
  "
              >
                ...
                {course?.isTechnicalCourse && (
                  <TabsTrigger value="compiler" className="text-xs sm:text-sm">
                    <Code2 className="w-4 h-4 mr-1" /> Compiler
                  </TabsTrigger>
                )}
                <TabsTrigger value="community" className="text-xs sm:text-sm">
                  <MessageSquare className="w-4 h-4 mr-1" /> Community
                </TabsTrigger>
              ...
              <TabsContent value="overview" className="space-y-6 mt-6">
                {/* About Instructor - Buttons at bottom on mobile */}
                  ...
                  <CardContent>
                    <div className="flex flex-col gap-4">
                      <div className="flex gap-4">
                        <div className="w-14 h-14 rounded-full overflow-hidden border-4 border-white shadow-lg flex-shrink-0">
                          <img
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-sm text-muted-foreground">
                            Expert Instructor • {course.totalStudents || 1200}+ Students
                          </p>
                      ...
                      <div className="flex gap-2">
                        ...
                        <Link href={`/student/teacher/call-shedule/${course.teacherId?._id}?courseId=${course._id}`}>
                          <Button size="sm" variant="outline" className="rounded-full border-green-600 text-green-600 hover:bg-green-700 hover:text-white">
                      ...
                      <CardHeader className="pb-4">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                          ...
                          <select
                            ...
                            className="bg-primary/5 border border-primary/20 text-foreground rounded-md px-3 py-1.5 text-sm focus:outline-none focus:ring-2 focus:ring-primary/50"
                          >
          ...
          {/* Right Sidebar: Progress + Course Content */}
        ...
        {/* Recommended Courses - Appears at the very bottom on mobile */}
        <div className="mt-12">
