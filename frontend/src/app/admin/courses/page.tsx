      ...
      <main className="flex-1 overflow-y-auto p-6 md:p-10">
        ...
        <div className="mb-6">
          <input
            ...
            className="border border-gray-300 rounded-lg p-2 w-full md:w-1/3 focus:outline-none focus:ring-2 focus:ring-indigo-400"
          />
        </div>
        ...
        {loading ? (
          ...
          <div className="text-gray-500 text-center py-10">No courses found.</div>
        ) : (
                ...
                <div className="bg-white rounded-xl shadow-md hover:shadow-lg transition-all overflow-hidden group border border-gray-100 hover:scale-[1.02] duration-200 flex flex-col h-[480px]">
                  ...
                  <div className="p-5 flex flex-col flex-1">
                    <div className="flex-1">
                      <h2 className="text-lg font-semibold text-gray-800 mb-1 group-hover:text-indigo-600 transition line-clamp-1">
                        {course.title}
                      </h2>
                    ...
                    {course.price && (
                      <div className="mt-auto text-right font-bold text-indigo-600 text-lg">₹{course.price}</div>
                    )}
                  </div>
                </div>
              </Link>
