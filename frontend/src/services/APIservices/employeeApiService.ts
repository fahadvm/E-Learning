...
export const employeeApiMethods = {
  ...
  getCommentReplies: (commentId: string) => get(EMPLOYEE_ROUTES.courses.getReplies(commentId)),
  toggleCommentLike: (commentId: string) => post(EMPLOYEE_ROUTES.courses.toggleLike(commentId), {}),
  toggleCommentDislike: (commentId: string) => post(EMPLOYEE_ROUTES.courses.toggleDislike(commentId), {}),
  addCourseComment: (courseId: string, data: { content: string, parentId?: string }) => post(EMPLOYEE_ROUTES.courses.comments(courseId), data),
