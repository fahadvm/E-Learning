...
export const STUDENT_ROUTES = {
  ...
  courses: {
    ...
    getReplies: (commentId: string) => `${STUDENT_COURSES}/comment/replies/${commentId}`,
    toggleLike: (commentId: string) => `${STUDENT_COURSES}/comment/like/${commentId}`,
    toggleDislike: (commentId: string) => `${STUDENT_COURSES}/comment/dislike/${commentId}`,
