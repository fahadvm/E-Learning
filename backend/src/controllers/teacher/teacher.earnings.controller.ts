...
export class TeacherEarningsController implements ITeacherEarningsController {
    constructor(
        @inject(TYPES.TeacherEarningsService) private readonly _earningsService: ITeacherEarningsService
    ) { }
    ...
    async getEarningsHistory(req: AuthRequest, res: Response): Promise<void> {
        ...
        sendResponse(res, STATUS_CODES.OK, 'Earnings history fetched successfully', true, result);
    }
    ...
    async getEarningsStats(req: AuthRequest, res: Response): Promise<void> {
        ...
        sendResponse(res, STATUS_CODES.OK, 'Earnings stats fetched successfully', true, stats);
    }
}
