...
exports.EmployeeLearningRecord = void 0;
const mongoose_1 = __importStar(require("mongoose"));
const LearningCourseSchema = new mongoose_1.Schema({
    courseId: { type: mongoose_1.Schema.Types.ObjectId, ref: 'Course', required: true },
    minutes: { type: Number, default: 0 },
}, { _id: false });
const EmployeeLearningRecordSchema = new mongoose_1.Schema({
...
exports.EmployeeLearningRecord = mongoose_1.default.model('EmployeeLearningRecord', EmployeeLearningRecordSchema);
