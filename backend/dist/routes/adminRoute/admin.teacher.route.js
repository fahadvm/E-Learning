...
teacherRouter.get('/unverified', (0, asyncHandler_1.asyncHandler)(adminTeacherCtrl.getUnverifiedTeachers.bind(adminTeacherCtrl)));
teacherRouter.get('/:teacherId', (0, asyncHandler_1.asyncHandler)(adminTeacherCtrl.getTeacherById.bind(adminTeacherCtrl)));
teacherRouter.get('/courses/:teacherId', (0, asyncHandler_1.asyncHandler)(adminTeacherCtrl.getTeacherCourses.bind(adminTeacherCtrl))); // new for courses
