...
router.post('/', (0, authMiddleware_1.authMiddleware)('student'), (0, asyncHandler_1.asyncHandler)(bookingCtrl.bookSlot.bind(bookingCtrl)));
...
router.patch('/:bookingId/approve', (0, authMiddleware_1.authMiddleware)('student'), (0, asyncHandler_1.asyncHandler)(bookingCtrl.approveBooking.bind(bookingCtrl)));
