...
let StudentAuthService = class StudentAuthService {
    ...
    googleAuth(idToken) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            logger_1.default.debug('Expected Audience:', GOOGLE_CLIENT_ID);
            logger_1.default.debug('Actual Audience from token:', payload.aud);
    ...
    sendEmailChangeOtp(studentId, newEmail) {
        return __awaiter(this, void 0, void 0, function* () {
