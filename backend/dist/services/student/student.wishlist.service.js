...
exports.StudentWishlistService = void 0;
...
let StudentWishlistService = class StudentWishlistService {
    ...
    removeCourse(studentId, courseId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return ((yield this._wishlistRepo.removeFromWishlist(studentId, courseId)) ||
...
exports.StudentWishlistService = StudentWishlistService;
exports.StudentWishlistService = StudentWishlistService = __decorate([
