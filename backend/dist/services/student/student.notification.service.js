...
let StudentNotificationService = class StudentNotificationService {
    ...
    markAsRead(notificationId) {
        return __awaiter(this, void 0, void 0, function* () {
            const updated = yield this._notificationRepo.markAsRead(notificationId);
            if (!updated)
    ...
    deleteNotification(notificationId) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this._notificationRepo.deleteNotification(notificationId);
            return true;
        });
    }
};
exports.StudentNotificationService = StudentNotificationService;
exports.StudentNotificationService = StudentNotificationService = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(types_1.TYPES.StudentNotificationRepository)),
