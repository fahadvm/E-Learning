...
exports.EmployeeLearningPathService = void 0;
...
let EmployeeLearningPathService = class EmployeeLearningPathService {
    constructor(_learningPathRepo, _employeeRepo) {
    ...
    getLearningPathDetail(employeeId, learningPathId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    updateProgress(employeeId, learningPathId, completedCourseIndex, courseId) {
        return __awaiter(this, void 0, void 0, function* () {
            var _a, _b;
            const progress = yield this._learningPathRepo.get(employeeId, learningPathId);
            if (!progress)
    ...
    updateStatus(employeeId, learningPathId, status) {
        return __awaiter(this, void 0, void 0, function* () {
            const progress = yield this._learningPathRepo.get(employeeId, learningPathId);
            if (!progress)
                (0, ResANDError_1.throwError)("Not Assigned", HttpStatuscodes_1.STATUS_CODES.FORBIDDEN);
...
exports.EmployeeLearningPathService = EmployeeLearningPathService;
exports.EmployeeLearningPathService = EmployeeLearningPathService = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(types_1.TYPES.EmployeeLearningPathProgressRepository)),
    __param(1, (0, inversify_1.inject)(types_1.TYPES.EmployeeRepository)),
    __metadata("design:paramtypes", [Object, Object])
], EmployeeLearningPathService);
