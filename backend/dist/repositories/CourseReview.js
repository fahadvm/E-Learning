...
exports.CourseReviewRepository = void 0;
const inversify_1 = require("inversify");
const CourseReview_1 = require("../models/CourseReview");
const mongoose_1 = __importDefault(require("mongoose"));
let CourseReviewRepository = class CourseReviewRepository {
    addReview(data) {
    ...
    getCourseReviewStats(courseId) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield CourseReview_1.CourseReview.aggregate([
...
exports.CourseReviewRepository = CourseReviewRepository;
exports.CourseReviewRepository = CourseReviewRepository = __decorate([
