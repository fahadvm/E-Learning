...
exports.EmployeeTeacherReviewController = void 0;
const inversify_1 = require("inversify");
const types_1 = require("../../core/di/types");
const ResANDError_1 = require("../../utils/ResANDError");
const ResponseMessages_1 = require("../../utils/ResponseMessages");
const HttpStatuscodes_1 = require("../../utils/HttpStatuscodes");
let EmployeeTeacherReviewController = class EmployeeTeacherReviewController {
    constructor(_reviewService) {
        ...
        this.addReview = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const review = yield this._reviewService.addReview(employeeId, teacherId, rating, comment);
        ...
        this.updateReview = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const updated = yield this._reviewService.updateReview(reviewId, employeeId, req.body);
        ...
        this.deleteReview = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const employeeId = (_a = req.user) === null || _a === void 0 ? void 0 : _a.id;
            const { reviewId } = req.params;
            yield this._reviewService.deleteReview(reviewId, employeeId);
...
exports.EmployeeTeacherReviewController = EmployeeTeacherReviewController;
exports.EmployeeTeacherReviewController = EmployeeTeacherReviewController = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(types_1.TYPES.EmployeeTeacherReviewService)),
    __metadata("design:paramtypes", [Object])
], EmployeeTeacherReviewController);
