...
exports.EmployeeCourseReviewController = void 0;
const inversify_1 = require("inversify");
const types_1 = require("../../core/di/types");
const ResANDError_1 = require("../../utils/ResANDError");
const HttpStatuscodes_1 = require("../../utils/HttpStatuscodes");
const ResponseMessages_1 = require("../../utils/ResponseMessages");
let EmployeeCourseReviewController = class EmployeeCourseReviewController {
    constructor(_reviewService) {
        ...
        this.addReview = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const review = yield this._reviewService.addOrUpdateReview(employeeId, courseId, rating, comment);
        ...
        this.deleteReview = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!reviewId)
                (0, ResANDError_1.throwError)(ResponseMessages_1.MESSAGES.ID_REQUIRED, HttpStatuscodes_1.STATUS_CODES.BAD_REQUEST);
            yield this._reviewService.deleteReview(employeeId, reviewId);
...
exports.EmployeeCourseReviewController = EmployeeCourseReviewController;
exports.EmployeeCourseReviewController = EmployeeCourseReviewController = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(types_1.TYPES.EmployeeCourseReviewService)),
    __metadata("design:paramtypes", [Object])
], EmployeeCourseReviewController);
