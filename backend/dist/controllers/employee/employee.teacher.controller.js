...
exports.EmployeeTeacherController = void 0;
const inversify_1 = require("inversify");
const types_1 = require("../../core/di/types");
const ResANDError_1 = require("../../utils/ResANDError");
const ResponseMessages_1 = require("../../utils/ResponseMessages");
const HttpStatuscodes_1 = require("../../utils/HttpStatuscodes");
let EmployeeTeacherController = class EmployeeTeacherController {
    constructor(_teacherService) {
        ...
        this.getTopTeachers = (req, res) => __awaiter(this, void 0, void 0, function* () {
...
exports.EmployeeTeacherController = EmployeeTeacherController;
exports.EmployeeTeacherController = EmployeeTeacherController = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(types_1.TYPES.EmployeeTeacherService)),
    __metadata("design:paramtypes", [Object])
], EmployeeTeacherController);
