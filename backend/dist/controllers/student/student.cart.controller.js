...
exports.StudentCartController = void 0;
const inversify_1 = require("inversify");
const types_1 = require("../../core/di/types");
const ResANDError_1 = require("../../utils/ResANDError");
const ResponseMessages_1 = require("../../utils/ResponseMessages");
const HttpStatuscodes_1 = require("../../utils/HttpStatuscodes");
let StudentCartController = class StudentCartController {
    constructor(_cartService) {
        ...
        this.getCart = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const cart = yield this._cartService.getCart(studentId);
        ...
        this.addToCart = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            const cart = yield this._cartService.addToCart(studentId, courseId);
        ...
        this.removeFromCart = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!courseId)
                (0, ResANDError_1.throwError)(ResponseMessages_1.MESSAGES.INVALID_ID, HttpStatuscodes_1.STATUS_CODES.BAD_REQUEST);
            const cart = yield this._cartService.removeFromCart(studentId, courseId);
            return (0, ResANDError_1.sendResponse)(res, HttpStatuscodes_1.STATUS_CODES.OK, ResponseMessages_1.MESSAGES.CART_UPDATED, true, cart);
        });
        this.clearCart = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (!studentId)
                (0, ResANDError_1.throwError)(ResponseMessages_1.MESSAGES.UNAUTHORIZED, HttpStatuscodes_1.STATUS_CODES.UNAUTHORIZED);
            const cart = yield this._cartService.clearCart(studentId);
...
exports.StudentCartController = StudentCartController;
exports.StudentCartController = StudentCartController = __decorate([
    (0, inversify_1.injectable)(),
    __param(0, (0, inversify_1.inject)(types_1.TYPES.StudentCartService)),
