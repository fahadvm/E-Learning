...
let AdminCourseController = class AdminCourseController {
    constructor(_adminCourseService) {
        this._adminCourseService = _adminCourseService;
    }
    getAllCourses(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const courses = yield this._adminCourseService.getAllCourses(page, limit, search);
    ...
    getUnverifiedCourses(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const courses = yield this._adminCourseService.getUnverifiedCourses();
            (0, ResANDError_1.sendResponse)(res, HttpStatuscodes_1.STATUS_CODES.OK, ResponseMessages_1.MESSAGES.COURSES_FETCHED, true, courses);
        });
    }
    getCourseById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const course = yield this._adminCourseService.getCourseById(req.params.courseId);
    ...
    verifyCourse(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const course = yield this._adminCourseService.verifyCourse(req.params.courseId);
            (0, ResANDError_1.sendResponse)(res, HttpStatuscodes_1.STATUS_CODES.OK, ResponseMessages_1.MESSAGES.COURSES_FETCHED, true, course);
        });
    }
    ...
    unblockCourse(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const course = yield this._adminCourseService.unblockCourse(req.params.courseId);
            (0, ResANDError_1.sendResponse)(res, HttpStatuscodes_1.STATUS_CODES.OK, ResponseMessages_1.MESSAGES.COURSES_FETCHED, true, course);
        });
    }
};
...
exports.AdminCourseController = AdminCourseController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(types_1.TYPES.AdminCourseService)),
