...
let TeacherChatController = class TeacherChatController {
    constructor(_chatService) {
        ...
        this.getUserChats = (req, res) => __awaiter(this, void 0, void 0, function* () {
            ...
            (0, ResANDError_1.sendResponse)(res, HttpStatuscodes_1.STATUS_CODES.OK, ResponseMessages_1.MESSAGES.COURSE_DETAILS_FETCHED, true, chats);
        });
...
exports.TeacherChatController = TeacherChatController = __decorate([
    ...
    __param(0, (0, inversify_1.inject)(types_1.TYPES.TeacherChatService)),
